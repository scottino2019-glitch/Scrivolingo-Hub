...
export default function ScrivolingoLogo() {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" height="180" viewBox="0 0 1070 180" className="w-full max-h-16">
      <defs>
      ...
      <g filter="url(#shadow)">
        <g transform="translate(40, 34) rotate(-6, 50, 50) scale(1)">
          ...
          <path d="M18,18 Q5,5 2,22 Q5,28 15,22 Z" fill="url(#grad-ext-0-S)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M82,18 Q95,5 98,22 Q95,28 85,22 Z" fill="url(#grad-ext-0-S)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
        ...
        <g transform="translate(129, 46) rotate(6, 50, 50) scale(1)">
          <path d="M35,10 L50,-4 L65,10 Z" fill="url(#grad-ext-1-C)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M15,18 L26,8 L37,18 Z" fill="url(#grad-ext-1-C)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M63,18 L74,8 L85,18 Z" fill="url(#grad-ext-1-C)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          ...
          <g opacity="0.65">
            <ellipse cx="27" cy="58" rx="6.5" ry="3.5" fill="#ff4081" stroke="none" />
            <ellipse cx="63" cy="58" rx="6.5" ry="3.5" fill="#ff4081" stroke="none" />
          </g>
        </g>
        <g transform="translate(218, 40) rotate(-6, 50, 50) scale(1)">
          ...
          <path d="M15,10 H65 Q85,10 85,38 Q80,55 58,58 L85,90 H60 L38,62 H40 V90 H18 Z M40,24 H52 Q62,24 62,38 Q62,45 48,45 H40 Z" fill="url(#grad-ext-2-R)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <g clipPath="url(#clip-ext-2-R)"></g>
          <g stroke="#1e0b20" strokeWidth={2.7777777777777777} strokeLinejoin="round" strokeLinecap="round">
          ...
          <path d="M25,85 Q25,102 22,102 Q19,102 19,85 Z" fill="url(#grad-ext-2-R)" stroke="#1e0b20" strokeWidth={3.3333333333333335} strokeLinejoin="round" strokeLinecap="round" opacity="0.9" />
          <path d="M50,83 Q50,110 46,110 Q42,110 42,83 Z" fill="url(#grad-ext-2-R)" stroke="#1e0b20" strokeWidth={3.3333333333333335} strokeLinejoin="round" strokeLinecap="round" opacity="0.9" />
          <path d="M75,85 Q75,100 72,100 Q69,100 69,85 Z" fill="url(#grad-ext-2-R)" stroke="#1e0b20" strokeWidth={3.3333333333333335} strokeLinejoin="round" strokeLinecap="round" opacity="0.9" />
        </g>
        <g transform="translate(307, 34) rotate(6, 50, 50) scale(1)">
          <path d="M35,10 Q28,-5 34,-12 Q40,-12 40,-5 L41,10 Z" fill="url(#grad-ext-3-I)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M65,10 Q72,-5 66,-12 Q60,-12 60,-5 L59,10 Z" fill="url(#grad-ext-3-I)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          ...
          <g stroke="#1e0b20" strokeWidth={2.7777777777777777} strokeLinejoin="round" strokeLinecap="round">
            ...
            <circle cx="30.333333333333332" cy="2.3333333333333335" r="2.2" fill="#ffffff" stroke="none" />
            <circle cx="36.75" cy="8.75" r="1.1" fill="#ffffff" stroke="none" />
            <line x1="25.2" y1="0.5" x2="20.8" y2="-3.9000000000000004" stroke="#1e0b20" strokeWidth={2.7777777777777777} />
            <line x1="42.8" y1="0.5" x2="47.2" y2="-3.9000000000000004" stroke="#1e0b20" strokeWidth={2.7777777777777777} />
          </g>
          <g stroke="#1e0b20" strokeWidth={2.7777777777777777} strokeLinejoin="round" strokeLinecap="round">
            <circle cx="66" cy="4" r="12" fill="#ffffff" />
            <circle cx="64.8" cy="2.8" r="5.4" fill="#1e0b20" />
            <circle cx="62" cy="0" r="2.4000000000000004" fill="#ffffff" stroke="none" />
            <circle cx="69" cy="7" r="1.2000000000000002" fill="#ffffff" stroke="none" />
            <line x1="56.4" y1="-2" x2="51.6" y2="-6.800000000000001" stroke="#1e0b20" strokeWidth={2.7777777777777777} />
            <line x1="75.6" y1="-2" x2="80.4" y2="-6.800000000000001" stroke="#1e0b20" strokeWidth={2.7777777777777777} />
          </g>
          <g stroke="#1e0b20" strokeWidth={3.2} fill="none" strokeLinejoin="round" strokeLinecap="round">
            <circle cx="36" cy="49" r="10.5" />
            <circle cx="64" cy="49" r="10.5" />
            <line x1="46.5" y1="49" x2="53.5" y2="49" />
            <path d="M 25.5 49 Q 19 45 13 53" />
            <path d="M 74.5 49 Q 81 45 87 53" />
          </g>
        </g>
        <g transform="translate(396, 46) rotate(-6, 50, 50) scale(1)">
          ...
          <g stroke="#1e0b20" strokeWidth={0.8} strokeLinejoin="round" strokeLinecap="round">
            <path d="M 50 49 Q 37 45 30 52 Q 40 55 50 50.5 Q 60 55 70 52 Q 63 45 50 49 Z" fill="#1e0b20" />
          </g>
        </g>
        <g transform="translate(485, 40) rotate(6, 50, 50) scale(1)">
          <path d="M25,12 C18,2 8,10 12,25 C16,20 22,17 25,12 Z" fill="url(#grad-ext-5-O)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M75,12 C82,2 92,10 88,25 C84,20 78,17 75,12 Z" fill="url(#grad-ext-5-O)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          ...
          <path d="M80,80 Q98,82 105,72 Q112,62 102,55 Q96,51 90,62 Q85,72 80,80 Z" fill="url(#grad-ext-5-O)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
        ...
        <g transform="translate(574, 34) rotate(-6, 50, 50) scale(1)">
          <path d="M12,40 C-8,45 -12,20 -2,12 C2,22 8,30 12,40 Z M12,40 C-2,46 -4,55 0,60 C4,52 8,46 12,40 Z" fill="#2A1A4A" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M88,40 C108,45 112,20 102,12 C98,22 92,30 88,40 Z M88,40 C102,46 104,55 100,60 C96,52 92,46 88,40 Z" fill="#2A1A4A" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M18,18 Q5,5 2,22 Q5,28 15,22 Z" fill="url(#grad-ext-6-L)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M82,18 Q95,5 98,22 Q95,28 85,22 Z" fill="url(#grad-ext-6-L)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          ...
          <g opacity="0.65">
            <ellipse cx="12" cy="68" rx="6.5" ry="3.5" fill="#ff4081" stroke="none" />
            <ellipse cx="48" cy="68" rx="6.5" ry="3.5" fill="#ff4081" stroke="none" />
          </g>
        </g>
        <g transform="translate(663, 46) rotate(6, 50, 50) scale(1)">
          <path d="M35,10 L50,-4 L65,10 Z" fill="url(#grad-ext-7-I)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M15,18 L26,8 L37,18 Z" fill="url(#grad-ext-7-I)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M63,18 L74,8 L85,18 Z" fill="url(#grad-ext-7-I)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
        ...
        <g transform="translate(752, 40) rotate(-6, 50, 50) scale(1)">
          <path d="M40,12 L43,2 L50,8 L57,2 L60,12 Z" fill="#ffea00" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          ...
          <path d="M25,85 Q25,102 22,102 Q19,102 19,85 Z" fill="url(#grad-ext-8-N)" stroke="#1e0b20" strokeWidth={3.3333333333333335} strokeLinejoin="round" strokeLinecap="round" opacity="0.9" />
          <path d="M50,83 Q50,110 46,110 Q42,110 42,83 Z" fill="url(#grad-ext-8-N)" stroke="#1e0b20" strokeWidth={3.3333333333333335} strokeLinejoin="round" strokeLinecap="round" opacity="0.9" />
          <path d="M75,85 Q75,100 72,100 Q69,100 69,85 Z" fill="url(#grad-ext-8-N)" stroke="#1e0b20" strokeWidth={3.3333333333333335} strokeLinejoin="round" strokeLinecap="round" opacity="0.9" />
        </g>
        <g transform="translate(841, 34) rotate(6, 50, 50) scale(1)">
          <path d="M35,10 Q28,-5 34,-12 Q40,-12 40,-5 L41,10 Z" fill="url(#grad-ext-9-G)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <path d="M65,10 Q72,-5 66,-12 Q60,-12 60,-5 L59,10 Z" fill="url(#grad-ext-9-G)" stroke="#1e0b20" strokeWidth={5} strokeLinejoin="round" strokeLinecap="round" />
          <circle cx="34" cy="-11" r="4" fill="#fff" stroke="#1e0b20" strokeWidth={2.5} />
          <circle cx="33.5" cy="-11" r="1.8" fill="#1e0b20" />
          <circle cx="66" cy="-11" r="4" fill="#fff" stroke="#1e0b20" strokeWidth={2.5} />
          <circle cx="65.5" cy="-11" r="1.8" fill="#1e0b20" />
          ...
          <g stroke="#1e0b20" strokeWidth={0.8} strokeLinejoin="round" strokeLinecap="round">
            <path d="M 45 56 Q 32 52 25 59 Q 35 62 45 57.5 Q 55 62 65 59 Q 58 52 45 56 Z" fill="#1e0b20" />
          </g>
        </g>
        <g transform="translate(930, 46) rotate(-6, 50, 50) scale(1)">
